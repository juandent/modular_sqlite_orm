...
// Note these had a value from previous headers
...
export module sqlite_schema_table;
import column;
import table;
import alias;
...
export
{
    namespace sqlite_orm {
        ...
        inline auto make_sqlite_schema_table() {
            return make_table<sqlite_master>("sqlite_master",
        ...
        inline constexpr auto var = "sqlite_schema"_alias;
        inline constexpr auto sqlite_schema = var.for_<sqlite_master>();
#endif
    }
}
